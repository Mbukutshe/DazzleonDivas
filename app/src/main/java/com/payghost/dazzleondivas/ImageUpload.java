...
public class ImageUpload extends AppCompatActivity implements View.OnClickListener {
    ...
    private String UPLOAD_URL ="http://mydm.co.za/Diva/Galleryupload.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayout = (RelativeLayout) findViewById(R.id.layout_gallery);
        relativeLayout.getBackground().setAlpha(230);

        requestQueue = Volley.newRequestQueue(getApplicationContext());

        buttonUpload = (Button)findViewById(R.id.btn_gallery_upload);
        buttonChoose = (Button)findViewById(R.id.btn_choose_gallery);
        Gallery = (ImageView)findViewById(R.id.gallery_view);
    ...
    private void uploadImage(){
        ...
        try {
            ...
            Toast.makeText(ImageUpload.this,e.toString(),Toast.LENGTH_LONG).show();
        }
    }
